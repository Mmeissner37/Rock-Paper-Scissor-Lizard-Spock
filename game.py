...
class Game:
    ...
    def determine_winner(self):
        ...
        elif self.player_one.chosen_gesture == "1" and (self.player_two.chosen_gesture == "Rock" or self.player_two.chosen_gesture == "Spock"):
            self.player_one.win = (self.player_one.win + 1)
        ...
        elif self.player_two.chosen_gesture == "1" and (self.player_one.chosen_gesture == "Rock" or self.player_one.chosen_gesture == "Spock"):
